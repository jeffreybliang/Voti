...
const SongTable = React.memo(({ songs, handleDelete }) => {
  return (
            ...
            <table className="table-auto w-full rounded-xl">
              <thead>
                <tr className="bg-gray-50">
                  <th className="p-2 w-12 text-center whitespace-nowrap text-sm sm:text-base font-semibold text-gray-900"></th>
              ...
              <tbody className="divide-y divide-gray-300">
                {songs.map((song, index) => (
                  ...
                  >
                    ...
                    <td className="py-4 w-24 flex items-center justify-center">
                      <button
                        onClick={() => handleDelete(song)}
                        className="flex p-2 rounded-full bg-white group transition-all duration-500 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400"
