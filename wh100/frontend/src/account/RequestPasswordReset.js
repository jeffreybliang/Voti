  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center w-screen h-screen overflow-hidden fixed top-0 left-0">
        <div className="max-w-md mx-auto bg-white dark:bg-gray-700 p-6 rounded-2xl shadow-lg border border-gray-200">
          <h1 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 text-center mb-4">
            Reset Password
          </h1>
