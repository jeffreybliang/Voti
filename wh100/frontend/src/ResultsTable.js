                ...
                {showResultsTableSpinner ? (
                  ...
                  songs.map((song, index) => {
                    ...
                    return (
                      <tr
                        key={song.id}
                        className="bg-white transition-all duration-500 hover:bg-gray-200 dark:hover:bg-gray-200"
                      >
                      {/* <td className="px-4 w-12 text-sm sm:text-base text-center font-medium text-gray-900">
                        ...
                        <td className="py-4 w-24 flex items-center justify-center">
                          <button
                            ...
                            className={`flex p-2 rounded-full bg-white group transition-all duration-500 item-center ${
                              isVoted
                                ? "hover:bg-red-600"
                                : "hover:bg-green-600"
                            }`}
