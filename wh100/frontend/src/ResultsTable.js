...
const ResultsTable = React.memo(
  ({ showResultsTableSpinner, songs, handleAdd, handleDelete, votes = [] }) => {
                  ...
                  <tbody className="divide-y divide-gray-300">
                    {showResultsTableSpinner ? (
                      <tr>
                        <td
                          colSpan="100%"
                          className="py-4 text-center bg-red-50"
                        >
                          <Spinner />
                        </td>
                      </tr>
                        ...
                        return (
                          ...
                          {index + 1}
                            ...
                            <td className="py-4 w-24 flex items-center justify-center">
                              <button
                                onClick={() =>
                                  isVoted ? handleDelete(song) : handleAdd(song)
                                }
                                className={`flex p-2 rounded-full bg-red-50 group transition-all duration-500 item-center ${
                                  isVoted
                                    ? "hover:bg-red-600"
                                    : "hover:bg-green-600"
                                }`}
