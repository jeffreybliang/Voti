                  ...
                  <tbody className="divide-y divide-gray-300">
                    {showResultsTableSpinner ? (
                      ...
                      <tr>
                        <td
                          colSpan="100%"
                          className="py-4 text-center bg-red-50 text-gray-500"
                        >
                          No results found.
                        </td>
                      </tr>
                            ...
                            <td className="pr-3 sm:pr-1 align-middle">
                              <div className="flex items-center justify-center h-full">
                                <button
                                  ...
                                  className={`p-2 rounded-full bg-red-50 group transition-all duration-500 items-center ${
                                    isVoted
                                      ? "hover:bg-red-600"
                                      : "hover:bg-green-600"
                                  }`}
                                >
                                  {isVoted ? (
                                    ...
                                    >
                                      <path
                                        className="fill-green-600 group-hover:fill-white"
